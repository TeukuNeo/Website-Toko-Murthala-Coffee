...
<main class="content">
    <section class="contact-hero-section">
        <div class="container">
            <h1>Hubungi Kami</h1>
            <p>Kami senang bisa terhubung dengan Anda. Kirimkan pertanyaan atau pesan Anda melalui formulir di bawah ini.</p>
        </div>
    </section>
                ...
                <div class="contact-details">
                    ...
                    <ul class="contact-list">
                        <li>
                            ...
                            <p><strong>Alamat:</strong> <br>Jl. Sidodadi, Kuala Simeme, Kec. Namorambe, Kabupaten Deli Serdang, Sumatera Utara 20355</p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p><strong>Email:</strong> <br>info@murthalacoffee.com</p>
                        </li>
                    </ul>
                </div>

                <div class="contact-form-wrap">
                    <h2>Kirim Pesan by Whatsapp</h2>
                    <form action="" method="POST" class="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" placeholder="namaemail@email.com" required>
                        </div>
                        <div class="form-group">
                            <label for="message">Pesan</label>
                            <textarea id="message" name="message" rows="5" placeholder="Tulis pesan Anda di sini..." required></textarea>
                        </div>
                        <button onclick="sendToWhatsApp()" type="submit" class="submit-button">Kirim Pesan</button>
                    </form>
                </div>
            </div>
        </div>
...
<script src="js/sendToWhatsapp.js"></script>
